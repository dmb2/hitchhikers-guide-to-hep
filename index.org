...
**** Org-Mode
Org-mode was written by a physicist to aid in organizing
information.  Its facilities have grown so large, that they warrant
their own subsection here.  
***** TODO Write Me
*** Vim
...
*** PyROOT
PyROOT are a set of python bindings to ROOT. 
