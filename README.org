...
Before we move onto the next topic, an note on methods.  Most of the
...
prototyping with a shell type environment.  [[Try%20learning%20it%20the%20hard%20way][Try learning it the hard
...
- [[https://en.wikibooks.org/wiki/Non-Programmer%2527s_Tutorial_for_Python_3][A non-programmer's tutorial on python 3]] (also see the linked version
